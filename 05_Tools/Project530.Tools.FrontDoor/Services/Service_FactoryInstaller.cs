...
#pragma warning restore RS0030
        ...
        var content = "# Five30 Vault — generated by Front Door" + Environment.NewLine
            + "VAULT_API_KEY=" + keys.VaultApiKey + Environment.NewLine
            + "DATABASE_PASSWORD=" + keys.DatabasePassword + Environment.NewLine
            + "FIVE30_GATEKEEPER_ENABLED=false" + Environment.NewLine;
#pragma warning disable RS0030
