...
#pragma warning restore RS0030
        ...
        var content = string.Join(Environment.NewLine,
            ...
            "# ============================================================================",
            "# Copy this file to `.env.local` and populate with your actual API keys.",
            "# The `.env.local` file is in .gitignore and MUST NOT be committed.",
            "# ============================================================================",
            "",
            "# --- LLM Gateway Keys ---",
            "# Used by Service_ForemanOrchestrator for AI agent task delegation.",
            $"OPENROUTER_API_KEY={keys.OpenRouterApiKey}",
            "",
            "# Used by Gemini-Architect agent (audit, scribe functions).",
            $"GEMINI_API_KEY={keys.GeminiApiKey}",
            "",
            "# Used for fast inference via Groq provider.",
            $"GROQ_API_KEY={keys.GroqApiKey}",
            "",
            "# --- System Configuration ---",
            "# Set to 'true' to enable the Gatekeeper linguistic filter middleware.",
